...
MODEL_PATH = os.path.join(BASE_PATH, 'modelo_rf_comparativo.joblib')
...
def predict_rf_image():
    ...
    plt.title("Resultado Clasificacion Random Forest (Pixel-Based)")
    plt.axis('off')
    plt.tight_layout()
    plt.show()

    save_path = os.path.join(BASE_PATH, 'resultado_rf.tif')
